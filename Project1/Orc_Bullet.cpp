...
Orc_Bullet::Orc_Bullet(sf::Vector2f startPos, sf::Vector2f dir, std::shared_ptr<Targetable> targetUnit, float t_damage, float t_projectile_speed)
    : Projectile(startPos, dir, t_projectile_speed, t_damage, targetUnit)
{
    sf::Vector2f size{ 2.0f, 40.0f };
    body.setSize(size);
